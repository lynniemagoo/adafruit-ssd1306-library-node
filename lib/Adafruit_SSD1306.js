...
const {delay, extractOption} = Adafruit_GFX_Library.Utils;
...
class Adafruit_SSD1306 extends Display_Base {
    ...
    */
    ...
    _preStartup() {
        const self = this;
        self._hardwareConstruct(); // (process SPI, I2C options)
    ...
    */
    ...
    begin() {
        ...
        if ((self.WIDTH == 128) && (self.HEIGHT == 32)) {
            ...
            constrast = (SSD1306_EXTERNALVCC === vccSelection) ? 0x9F : 0xCF;
        } else if ((self.WIDTH == 96) && (self.HEIGHT == 16)) {
            comPins = 0x02;
            constrast = (SSD1306_EXTERNALVCC === vccSelection) ? 0x10 : 0xAF;
        } else {
            // TBD.
            comPins = 0x02;
            constrast = 0x8F;
    ...
    */
    ...
    /**
     * Clear the contents of display buffer (set all pixels to off.).
